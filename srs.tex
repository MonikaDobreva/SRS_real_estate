...
\begin{description}
    ...
    \item[B.V.] - Besloten Vennootschap (a private limited liability company under Dutch law)
    \item[CEO] - Chief Executive Officer 
    \item[ICT] - Information and Communications Technology
    \item[LTIF] - Limburg Technology Investment Fund
    \item[REST] - REpresentational State Transfer 
    \item[SRS] - Software Requirements Specification 
    \item[UI] - User Interface 
    \item[UML] - Unified Modeling Language 
    \item[WOZ] - Waardering Onroerende Zaken (Valuation of Immovable Property, a Dutch property valuation system)
\end{description}
\newpage
